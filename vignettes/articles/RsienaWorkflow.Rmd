...
### weak coordination
ts_ansWC <- ts_estim(ans = ans3, nite = 250, conv = 0.01, parallel = TRUE, phase3 = FALSE, p2step = c(0,1,0), dist1 = 2, dist2 = 2)
fsave(ts_ansWC, "ts_ansWC.rda")

### strict coordination
ts_ansSC <- ts_estim(ans = ans3, nite = 250, conv = 0.01, parallel = TRUE, phase3 = FALSE, p2step = c(0,1,0), dist1 = 2)
...
```{r, echo=FALSE}
load("./data/processed/20231031ts_ansS.rda")
ts_ansS <- x
rm(x)
load("./data/processed/20231031ts_ansWC.rda")
ts_ansWC <- x
rm(x)
load("./data/processed/20231101ts_ansSC.rda")
ts_ansSC <- x
rm(x)
load("./data/processed/20231101ts_ansST.rda")
ts_ansST <- x
rm(x)
```
