...
p <- ggplot(df, aes(x=x, y=y, fill=factor(type, levels=c("ministep", "twostep: simultaneity", "twostep: weak coordination", "twostep: strict coordination")))) + 
...
p1 <- ggplot(dftest, aes(x=x, y=y, fill=factor(type, levels=c("ministep", "twostep: simultaneity", "twostep: weak coordination", "twostep: strict coordination")))) + 
  geom_violin(position=position_dodge(.9)) + 
  stat_summary(fun = mean,
               geom = "errorbar",
               fun.max = function(x) mean(x) + sd(x),
...
p2 <- ggplot(dftest, aes(x=x, y=y, fill=factor(type, levels=c("ministep", "twostep: simultaneity", "twostep: weak coordination", "twostep: strict coordination")))) + 
  geom_violin(position=position_dodge(.9)) + 
  stat_summary(fun = mean,
               geom = "errorbar",
               fun.max = function(x) mean(x) + sd(x),
...
p3 <- ggplot(dftest, aes(x=x, y=y, fill=factor(type, levels=c("ministep", "twostep: simultaneity", "twostep: weak coordination", "twostep: strict coordination")))) + 
  geom_violin(position=position_dodge(.9)) + 
  stat_summary(fun = mean,
               geom = "errorbar",
               fun.max = function(x) mean(x) + sd(x),
...
For this network (`net1`) and given the network statistics degree, reciprocity and transitivity...  
...
For this network (`net1`) and given the network statistics degree, reciprocity, transitivity and mediated transitivity...  
