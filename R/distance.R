...
#'
#' @return numeric vector of length one, with the distance between the two egos. If egos are not connected `f_geodist` returns `Inf`.
#'
...
#' @export
#' @examples
#' f_geodist(net=net1, ego1=6, ego2=8, degree="outdegree")
#' f_geodist(net=net1, ego1=8, ego2=6, degree="outdegree")
#' f_geodist(net=net1, ego1=8, ego2=6, degree="degree")
#' @export
